...
builder.Services.AddIdentity<ApplicattionUser, IdentityRole>(options =>
    {
...
// ---- Seed de Roles e usuário Admin padrão ----
        using (var scope = app.Services.CreateScope())
        {
            ...
            var userManager = scope.ServiceProvider.GetRequiredService<UserManager<ApplicattionUser>>();
            ...
            {
                var admin = new ApplicattionUser
                {
                    UserName = emailAdmin,
                    Email = emailAdmin,
